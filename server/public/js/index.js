...
/***/ (function(module, exports) {
	...
	try {
	    for (var _iterator2 = new Foo('hello', 'word', 'af', fun())[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	        var x = _step2.value;
...

	{
	    ...
	    var Bar = function (_Foo2) {
	        ...
	        _createClass(Bar, null, [{
	            key: 'classMethod',
	            value: function classMethod() {
	                return _get(Bar.__proto__ || Object.getPrototypeOf(Bar), 'classMethod', this).call(this) + ',dd';
	            }
	        }]);
	    ...
	    console.log(_Foo.classMethod());
	    console.log(Bar.classMethod());
	}

	{
	    var IncreasingCounter = function () {
	    ...
	    var increaseCount = new IncreasingCounter();

	    increaseCount.increment();
	}

	{
	    var _Foo3 = function _Foo3() {
	        _classCallCheck(this, _Foo3);
	    };
	}
